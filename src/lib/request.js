const server_url = "http://wx.printhome.com/mall-web";
const img_url = "http://img.printhome.com/imgs/";
const img_url_cgl = "http://img.printhome.com/imgs";
const commonPlatformId = 3;
const varants_commonPlatformId = "commonPlatformId";
//本地获取uid字符串
const currentUserUid = "currentUserUid";
//本地获取当前用户信息字符串
const currentUserInfo = "currentUserInfo";
//购物车获取缓存key
const myCartKey = "myCartKey";
/**
 * 获取接口地址
 * @param name 接口名
 * @returns {string}
