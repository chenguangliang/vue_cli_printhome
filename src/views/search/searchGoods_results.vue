      ...
      <div class="top_wrapper">
        ...
        <div class="search_wrapper" style="width: 5rem">
          ...
          <div style="display: inline-block; float: right; margin: 3px 10px 0 0;">
            <!--<img class="chahao" src="../../assets/img/chahao.png" alt=""/>-->
            <img class="fangda" src="../../assets/img/fangdajing.png" alt="" onclick="searchList()"/>
          </div>
        </div>
        <img class="toggle_img" src="../../assets/img/suoluetu-@3x.png" alt="" @click="toggleShow" id="switchPic"/>
        <img class="toggle_img" src="../../assets/img/suojia_bg.png" alt="" @click="toggleShow" id="switchPic"/>
      </div>
