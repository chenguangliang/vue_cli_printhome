...
function threeStepSubmit(){
    ...
    $.jsonAjax(getUrl("user/findPWDThree"),{captchaType:"find_pay_pwd",picCaptcha:picCaptcha,phoneCaptcha:phoneCaptcha,phone:phone,newPwd:$("#twoPwd").val(),areaCode:areaCode},function(data){
        if(data.success){
            //获取用户信息
            StorageUtil.setUserInfo();
            window.location = "../../html/12_maiJiaZhongXin/6_anQuanXinXiSheZhi_zhaoHuiZhiFuMiMa4.html";
        }else{
