        ...
        'submitInfo.payDelay': function (newvalue , oldvalue) {
            if(newvalue==1){
                if(this.submitInfo.totalAmount<1){
                    printAlert('小于1元的订单不能选择延期支付！');
                    this.submitInfo.payDelay=0;
                    $(".delayPayWrap").hide();
                }
            }
            /*if(newvalue==0){
                this.submitInfo.isPeriod=0;
                this.submitInfo.periodDetailsBuffer='';
            }*/
        }
    }
