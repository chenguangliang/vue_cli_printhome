...
/*$(function(){
    productDetail.$data.itemId = itemId;
    productDetail.$data.skuId = skuId;
})*/
...
var productDetail = new Vue({
    ...
    methods:{
        ...
        loadEvaluation:function () {
            ...
            $.jsonAjax(getUrl("productController/getItemEvaluation"), filterJSONNULL(paramData), function (data, status, xhr) {
                if (data.isSuccess) {
        ...
        initServiceAuth:function() {
            ...
            $.jsonAjax(getUrl("sellcenter/service/serviceAuth"), filterJSONNULL(paramData), function (data, status, xhr) {
                if (data.isSuccess) {
    ...
    beforeMount:function(){
        ...
        //如果skuId不为空时
        if(isNotBlank(this.skuId) && this.skuId !="null"){
