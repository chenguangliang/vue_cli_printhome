...
var xunjia_xunjiaInfo = new Vue({
    ...
    beforeCreate: function () {
        $.jsonAjax(getUrl("requestPriceController/requestPriceCreate"), {}, function (data, status, xhr) {
            uName = data.uName;
            uid = data.uid;
...
function startUpload(){
    ...
    $.uploadFile({
        ...
        success: function (data, status){  //服务器成功响应处理函数
            ...
            if(data.success){
                ...
                xunjia_xunjiaInfo.$data.annex = data.result;
                xunjia_xunjiaInfo.$data.oldFileName = fileInput;
            }else{
    ...
    //                     // xunjia_xunjiaInfo.$data.oldFileName = arr[arr.length - 1];
    //
    //                     xunjia_xunjiaInfo.$data.oldFileName = fileInput;
    //                 }
    //
...
function clearFile() {
    xunjia_xunjiaInfo.$data.annex = '';
    xunjia_xunjiaInfo.$data.oldFileName = '';
}
function getRandom(){
